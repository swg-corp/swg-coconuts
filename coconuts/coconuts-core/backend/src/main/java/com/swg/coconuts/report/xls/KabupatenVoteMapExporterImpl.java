...
@Component
public class KabupatenVoteMapExporterImpl extends AbstractXlsExporter<VoteMap> implements KabupatenVoteMapExporter{
	...
	@Override
	public Collection<VoteMap> getData(Provinsi source) {
		List<Kabupaten> kabupatens=kabupatenRepository.findByProvinsi(source);
